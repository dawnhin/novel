...
+ (void)bookDetail:(NSString *)bookId
    ...
    [NovelNetManager bookDetail:bookId success:^(id  _Nonnull object) {
    ...
    dispatch_group_enter(group);
    [NovelNetManager bookCommend:bookId success:^(id  _Nonnull object) {
    ...
    dispatch_group_enter(group);
    [NovelNetManager bookListCommend:bookId success:^(id  _Nonnull object) {
